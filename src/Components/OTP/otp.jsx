...
const Otp =()=>{
    ...
    useEffect(()=>{
        ...
        if(otpValue) {
         ...
         const response =  await fetch("https://mmt-project-backend.vercel.app/api/verifyOTP", options);
    ...
    useEffect(()=>{
        ...
        if(otpResendValue) {
         ...
         const response =  await fetch("https://mmt-project-backend.vercel.app/api/resendOTP", options);
         const data = await response.json();
     }
     fetchApi(); 
     }
